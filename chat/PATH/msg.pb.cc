...
void protobuf_AssignDesc_PATH_2fmsg_2eproto() {
  protobuf_AddDesc_PATH_2fmsg_2eproto();
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_PATH_2fmsg_2eproto);
}
...
void protobuf_ShutdownFile_PATH_2fmsg_2eproto() {
  delete helloworld::default_instance_;
  delete helloworld_reflection_;
}

void protobuf_AddDesc_PATH_2fmsg_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\016PATH/msg.proto\022\002lm\"%\n\nhelloworld\022\n\n\002id"
    "\030\001 \002(\005\022\013\n\003str\030\002 \002(\t", 59);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "PATH/msg.proto", &protobuf_RegisterTypes);
  helloworld::default_instance_ = new helloworld();
  helloworld::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_PATH_2fmsg_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_PATH_2fmsg_2eproto {
  StaticDescriptorInitializer_PATH_2fmsg_2eproto() {
    protobuf_AddDesc_PATH_2fmsg_2eproto();
  }
} static_descriptor_initializer_PATH_2fmsg_2eproto_;
...
const helloworld& helloworld::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_PATH_2fmsg_2eproto();
